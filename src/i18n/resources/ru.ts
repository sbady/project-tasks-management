...
export const ru: TranslationTree = {
	...
	modals: {
		...
		task: {
			...
			actions: {
			due: "Установить финальный срок",
			scheduled: "Установить план",
	...
	contextMenus: {
		task: {
			...
			reminders: "Напоминания",
			remindBeforeDue: "Напомнить до финального срока…",
			remindBeforeScheduled: "Напомнить до плана…",
