# Knowledge Base Agent Core (KBAC) — интеграция с Obsidian-плагином

## 1. Что такое KBAC
Knowledge Base Agent Core (KBAC) — это не “умный чат” и не “AI note writer”.
...
## 9. Вывод
KBAC строится вокруг workflow + KB + orchestration.
